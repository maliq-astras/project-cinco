export const gameControlsStyles = {
  ...
  wrongGuessToast: "hidden bg-red-100 text-red-800 py-2 px-4 rounded-md text-sm font-medium border border-red-200 shadow-md animate-slideInRight font-mono",
