...
const BugReportSection: React.FC = () => {
  ...
  return (
    <div className={bugReportSectionStyles.container}>
      <h2 
        className={`${bugReportSectionStyles.header} ${righteous.className}`}
        style={bugReportSectionStyles.headerStyle(colors.primary)}
      >
        REPORT A BUG
      </h2>
      <div className={bugReportSectionStyles.formContainer}>
        <AnimatePresence mode="wait">
          {step === 0 && !submitted && (
            ...
            >
              <label className={bugReportSectionStyles.label}>
                {steps[0].label}
              </label>
              <div className={bugReportSectionStyles.dropdownWrapper}>
                <div className={bugReportSectionStyles.dropdownRelativeContainer}>
                  <div 
                    ...
                    style={bugReportSectionStyles.dropdownTriggerStyle(colors.primary)}
                  ...
                  {isDropdownOpen && (
                    <div 
                      ...
                      style={bugReportSectionStyles.dropdownContainerStyle(colors.primary)}
                    >
                      {bugOptions.map((option) => (
                        <div
                          key={option}
                          className={bugReportSectionStyles.dropdownOption}
                          style={bugReportSectionStyles.dropdownOptionStyle(bugType === option, colors.primary)}
              ...
              {bugType === 'Other' && (
                <>
                  <input
                    type="text"
                    maxLength={50}
                    className={bugReportSectionStyles.input}
                    style={bugReportSectionStyles.inputStyle(colors.primary)}
                  ...
                  />
                  <button
                    className={bugReportSectionStyles.button}
                    style={bugReportSectionStyles.buttonStyle(colors.primary)}
                    onClick={handleNext}
                    ...
                    >
                      {deviceOptions.map((option) => (
                        <div
                          key={option}
                          className={bugReportSectionStyles.dropdownOption}
                          style={bugReportSectionStyles.dropdownOptionStyle(deviceType === option, colors.primary)}
          ...
          {step === 2 && !submitted && (
            ...
            >
              ...
              <textarea
                className={bugReportSectionStyles.textarea}
                style={bugReportSectionStyles.textareaStyle(colors.primary)}
            ...
            >
              ...
              {!file ? (
                <div
                  ...
                  style={bugReportSectionStyles.fileUploadContainerStyle(isDragging, colors.primary)}
      ...
      <div className={bugReportSectionStyles.progressContainer}>
        <div 
          className={bugReportSectionStyles.progressBar}
          style={bugReportSectionStyles.progressBarStyle(progress, colors.primary)}
        />
      </div>
    </div>
  );
