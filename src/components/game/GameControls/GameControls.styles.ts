export const gameControlsStyles = {
  ...
  skipTooltipCaret: "absolute right-7 sm:right-6 -bottom-1 w-2 h-2 rotate-45",
  submitButton: "absolute right-2 top-1/2 -translate-y-1/2 font-display text-xs sm:text-sm font-bold px-1.5 sm:px-2 py-1 rounded-md transition-opacity duration-200",
