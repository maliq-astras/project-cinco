...
const animalData = [
  {
    ...
    facts: {
      ...
      "Size/Weight": {
        en: "I typically weigh between 1.5 and 5 pounds, with males being considerably larger than females of my species.",
        es: "Típicamente peso entre 0.7 y 2.3 kilogramos, siendo los machos considerablemente más grandes que las hembras de mi especie."
      },
      "Evolutionary History": {
  ...
  },
  {
    ...
    facts: {
      ...
      "Size/Weight": {
        en: "My species range dramatically in size, from the tiny 1-inch long Octopus wolfi to giants with arm spans reaching over 30 feet.",
        es: "Mis especies varían dramáticamente en tamaño, desde el diminuto Octopus wolfi de 2.5 centímetros hasta gigantes con envergaduras de más de 9 metros."
      },
      "Evolutionary History": {
